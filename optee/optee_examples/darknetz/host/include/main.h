...
// Secure storage
#define MAX_FILE_SIZE 1024 * 1024  // 假设文件最大为1MB
#define SECURE_STORE_WRITE_FILE_CMD 101  // TA命令ID，用于安全存储写入文件
#define SECURE_STORE_READ_FILE_CMD 102  // TA命令ID，用于安全存储读取文件
#define SECURE_STORE_DELETE_FILE_CMD 103  // TA命令ID，用于安全存储删除文件

#define FORWARD_IR_CORRECT_CMD 201  // TA命令ID，用于中间结果IR校正
#define TRANS_WEIGHTS_PRIME_CMD 202 // TA命令ID，用于传递混淆权重
